...
const ADMIN_ENTRIES: AdminEntry[] = [
  ...
  { path: "/admin/ai", icon: BrainCircuit, title: ["AI 配置", "AI settings"], description: ["配置 AI 供应商、模型和资源限制。", "Configure AI providers, models, and resource limits."], superAdminOnly: true },
