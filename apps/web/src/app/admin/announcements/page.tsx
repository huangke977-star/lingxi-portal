...
export default function AnnouncementAdminPage() {
  ...
  return <section className="page-shell announcement-admin-page">
    <AdminPageHeader description={phrase("发布和管理站点公告。", "Publish and manage site announcements.")} title={phrase("公告管理", "Announcement management")} actions={<button aria-label={phrase("新建公告", "New announcement")} className="admin-header-icon-action" onClick={() => setEditor({ id: null, status: "draft", input: { ...emptyInput } })} title={phrase("新建公告", "New announcement")} type="button"><Plus aria-hidden="true" size={16} /></button>} />
